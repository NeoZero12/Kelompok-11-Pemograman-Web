    ...
    <div className="bg-black text-white selection:bg-blue-500/20 font-poppins overflow-x-hidden scroll-smooth">
      ...
      <main className="min-h-screen pt-24 md:pt-32 pb-20 px-4 sm:px-10 md:px-16 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start"> 
            ...
            >
              ...
              <motion.div variants={scrollReveal} className="flex items-center gap-3 mb-8 bg-zinc-900/50 border border-white/5 w-fit p-2 pr-4 md:p-3 rounded-xl mx-auto lg:mx-0 hover:bg-zinc-800/50 transition-colors">
                <img src={DataImage.nizamImage} alt="nizam" className="w-8 h-8 md:w-10 md:h-10 object-cover rounded-lg"/>
              ...
              <motion.div variants={scrollReveal} className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                <div className="p-5 bg-white/5 border border-white/10 rounded-2xl transition-all hover:border-blue-500/50 group">
                  ...
                  <p className="text-base md:text-lg font-semibold text-zinc-200">Kota Kediri</p>
                </div>
                <div className="p-5 bg-white/5 border border-white/10 rounded-2xl transition-all hover:border-blue-500/50 group">
              ...
              >
                ...
                <div className="p-6 md:p-10 bg-blue-500/5 border-l-4 border-blue-600 rounded-r-3xl shadow-2xl shadow-blue-900/5 backdrop-blur-sm">
                  <p className="text-zinc-400 leading-relaxed text-sm md:text-lg text-justify mb-6">
                    Saya adalah <span className="text-white font-medium">Muhammad Nizam Putra Rasya</span>, 
                    mahasiswa aktif program studi <strong>D-III Teknologi Informasi di Universitas Brawijaya</strong>. 
                    Berdomisili di Kota Kediri, saya memiliki ketertarikan mendalam pada dunia pengembangan perangkat lunak 
          ...
          <section id="achievement" className="mt-40 scroll-mt-28">
            ...
            >
              {[
                { rank: "🥉", title: "Juara 3", desc: "Kejuaraan DANDIM CUP 2" },
                { rank: "🥈", title: "Juara 2", desc: "Kejuaraan IKSCUP" }
              ].map((item, index) => (
                <motion.div 
                  key={index}
                  variants={scrollReveal}
          ...
          <section id="contact" className="mt-40 pb-20 scroll-mt-28">
            ...
            >
              {[
                { name: "WhatsApp", icon: "💬", link: "https://wa.me/6281217052097", color: "hover:border-green-500/50 group-hover:text-green-400" },
                { name: "Instagram", icon: "📸", link: "https://instagram.com/nizmmptra_", color: "hover:border-pink-500/50 group-hover:text-pink-400" },
                { name: "LinkedIn", icon: "💼", link: "https://linkedin.com/in/nizamputra", color: "hover:border-blue-500/50 group-hover:text-blue-400" },
                { name: "Email", icon: "✉️", link: "mailto:nizamputrarasya007@gmail.com", color: "hover:border-red-500/50 group-hover:text-red-400" }
              ].map((social, index) => (
                <motion.a
                  key={index}
                  href={social.link}
      ...
      <footer className="py-10 border-t border-white/5 text-center">
        <p className="text-zinc-600 text-[10px] md:text-xs tracking-[0.3em] uppercase font-bold">
          © {new Date().getFullYear()} Muhammad Nizam Putra Rasya. All Rights Reserved.
        </p> 
      </footer>
    </div>
  );
